...
public class WDDemo3 {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i=1; i < data.length; i++) {
			price = findprice(data[i][0], data[i][1], data[i][2], data[i][3]);
			System.out.println("Price for flight from " + data[i][0] + " to " + data[i][1] + " is " + price);
			itin = "From : " + data[i][0] + " To : " + data[i][1];
			map.put(price, itin);
		}
	...
	public static double findprice(String orig, String dest, String stdate, String enddate) throws InterruptedException {
